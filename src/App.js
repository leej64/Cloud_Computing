...
function App() {
  ...
  const fetchData = async () => {
	try {
	  ...
	  const youtubeResponse = await axios.get('http://34.230.59.163:5984/youtube/_all_docs?include_docs=true&descending=true&limit=1', {
		auth: {
		  username: 'admin',
		  password: 'group6'
		}
	  ...
	  const spotifyResponse = await axios.get('http://34.230.59.163:5984/spotify/_all_docs?include_docs=true&descending=true&limit=1', {
		auth: {
		  username: 'admin',
		  password: 'group6'
		}
